...
const CATEGORIES = [
  ...
  { slug: "Spray & Garment Washed Hoodies", h1: "Spray & Garment Washed Hoodies — Hoodie Manufacturer in Karachi",
  ...
  { slug: "Washed Oversized Tees", h1: "Washed Oversized Tees — Ring-Spun Cotton Manufacturing in Karachi",
    copy: "Oversized washed T-shirts have become a staple of modern streetwear, and SHS specializes in producing them with premium ring-spun cotton for a softer hand feel and longer garment life. Our production includes acid wash, stone wash, mineral wash, garment wash, and tie-dye finishes, all available in low MOQs for growing fashion brands. Each wash creates its own unique character, allowing collections to stand apart in an increasingly competitive market." },
  ...
  { slug: "French Terry & Jersey Shorts, Joggers & Trousers", h1: "French Terry & Jersey Shorts, Joggers & Trousers — Karachi",
    copy: "Whether you're building a streetwear collection or everyday essentials, SHS manufactures premium French Terry and jersey bottoms designed for comfort, durability, and modern fits. Our production includes joggers, shorts, cargos, and relaxed trousers using cotton French Terry, single jersey, fleece, and other knitted fabrics with flexible low-MOQ manufacturing. From oversized silhouettes to clean everyday basics, we help brands create bottoms that customers actually wear on repeat." },
...
<link rel="canonical" href="https://shs-enterprises.com/portfolio.html">
...
<meta property="og:image" content="https://shs-enterprises.com/assets/logo.png">
...
<script type="application/ld+json">
{
  ...
  "url": "https://shs-enterprises.com/portfolio.html",
  "isPartOf": { "@type": "WebSite", "name": "SHS Enterprises", "url": "https://shs-enterprises.com" }
}
</script>
<style>
  :root{
...
<header class="fixed top-0 left-0 right-0 z-50 nav-blur border-b" style="border-color:var(--line);">
  <div class="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
    ...
    <nav class="hidden md:flex items-center gap-8 text-sm font-medium">
      ...
      <a href="portfolio.html" style="color:var(--red)">Portfolio</a>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-10 text-sm">
      <div>
        ...
        <ul class="space-y-2 muted">
          <li><a href="about.html" class="hover:text-[var(--red)]">About Us</a></li>
